...
public interface UmsIntegrationChangeHistoryDao {
     ...
     * @return 对象列表
     */
    List<UmsIntegrationChangeHistory> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<UmsIntegrationChangeHistory> queryAll(UmsIntegrationChangeHistory umsIntegrationChangeHistory);
