...
public interface SmsSeckillSessionDao {
     ...
     * @return 对象列表
     */
    List<SmsSeckillSession> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<SmsSeckillSession> queryAll(SmsSeckillSession smsSeckillSession);
